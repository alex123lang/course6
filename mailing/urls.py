...
urlpatterns = [
    ...
    path(
        "view/<int:pk>/", cache_page(60)(ClientDetailView.as_view()), name="client_view"
    ),
    ...
    path(
        "message_delete/<int:pk>/", MessageDeleteView.as_view(), name="delete_message"
    ),
    ...
    path(
        "mailing_delete/<int:pk>/", MailingDeleteView.as_view(), name="delete_mailing"
    ),
